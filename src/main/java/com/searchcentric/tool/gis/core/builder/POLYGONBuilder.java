...
public class POLYGONBuilder extends Builder {
    ...
    public Boolean build(DestinationConfig dest, Map<String, ColumnMeta> mapColumnMeta, Object mapData, Reporter reporter) {
        ...
        // load data
        reporter.reportInfo("Try toload data - \n" + mapData.toString());
        ...
        String ml = "ST_GeomFromText('POLYGON((";
...
//                        reporter.reportInfo("name " + ccfg.name);
                        newInsert = newInsert.replace("#" + ccfg.name + "#", buildValue(mapColumnMeta, dataSet.get(ccfg.name), ccfg.mapping, ccfg.type));
            ...
            try {
                ...
                reporter.reportInfo("Query: " + newInsert);
    ...
    private String buildValue(Map<String, ColumnMeta> mapColumnMeta, Set valueSet, String colName, String type) throws IllegalAccessException, InstantiationException {
        String retValue = "";
        ...
        if(clOb != null) {
            ...
            // using the specified type in the column dest description
            ...
            if(type.equalsIgnoreCase("double") || type.equalsIgnoreCase("bigdecimal")) {
                for(Object val : valueSet) {
                    retValue = val.toString();
                    break;
                }
